...
public class FavouriteMoviesAdapter extends RecyclerView.Adapter<FavouriteMoviesAdapter.ViewHolder> {
    ...
    Context context;
    String poster_url;
    boolean isFavourite,isAddedToFav;
            ...
            public void onClick(View v) {
                ...
                oa1.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        Log.d("This is ","Movie Id"+favouriteMovies.get(holder.getAdapterPosition()).getId()+" IN On BInd");
                       // openDetailsInBottomSheet(favouriteMovies.get(holder.getAdapterPosition()));
                        oa2.start();
                    }
                });
                oa1.start();
